...
/* PROBLEM 2 */
SELECT Arrival_Airport_FK
FROM flight
WHERE Departure_Airport_FK = 'SEA'
ORDER BY Departure_Airport_FK

/* PROBLEM 3 */
SELECT Departure_Airport_FK
FROM flight
...
SELECT Plane_FK
FROM flight 
WHERE Departure_Airport_FK = 'DEN'

/* PROBLEM 5 */
SELECT Num_Passengers, Cargo_Size
FROM plane
